...
const DepartmentDropdown: React.FC<DepartmentDropdownProps> = ({
  ...
  const handleClear = () => {
    ...
    return (
        <div>
            <div className={'flex flex-row items-center rows-2 gap-[18px] mr-[17px]'}>
                <img
                    src={DepartmentIcon}
                    alt="Department Icon"
                ...
                <div ref={depRef} className={'relative w-full'}>
                    ...
                    >
                        <input
                            type="text"
                            className="w-full rounded-3xl py-3 pl-3 pr-10 text-gray-700 font-[poppins] shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 sm:text-sm"
                            value={searchTerm}
                            ...
                            {sorted.map((department) => (
                                ...
                                >
                                    ...
                                    {selectedDepartment?.id === department.id && (
                                        <span className="absolute inset-y-0 right-0 flex items-center pr-4 text-[#003a96]">
                                            <svg
                                                className="h-5 w-5"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
