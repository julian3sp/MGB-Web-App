...
const DirectoryPage = () => {
    ...
    return (
        <div className="p-6 min-h-screen ">
            <h1 className="text-4xl font-bold mb-6 font-[poppins] text-gray-800">Admin Dashboard</h1>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Bar Chart */}
                <div className="col-span-1 lg:col-span-2 bg-white rounded-2xl p-6 shadow-lg border-1">
                    <h2 className="text-2xl font-semibold mb-4 font-[poppins] text-gray-800">Service Request Overview</h2>
                    <ChartContainer config={serviceRequestConfig} className="min-h-[280px]">
                ...
                <div>
                    <div className="bg-white p-5 rounded-2xl shadow-lg border-1 space-y-10">
                        <h2 className="text-lg font-[poppins] font-semibold text-gray-800">Import Tools</h2>
