            ...
            <div className="w-1/4 p-5 border-r border-gray-300 flex flex-col gap-4">
                ...
                {selectedNode && (
                    <div className=" bg-white shadow-lg border-2 border-frey rounded-2xl p-6 font-[poppins] text-center space-y-3 ">
                        ...
                        <p className="text-black text-lg"><span className="font-bold">Longitude:</span> {selectedNode.x.toFixed(6)}</p>
                        <p className="text-black text-lg"><span className="font-bold">Latitude:</span> {selectedNode.y.toFixed(6)}</p>
                    </div>
                )}
