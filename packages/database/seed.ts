...
async function main() {
    ...
    await insertServiceRequest('Alex','111111111','High','Chestnut Hill','Laboratory','Language','Done',prisma,'Spanish','French','','','','','','','','','','','','','');
    await insertServiceRequest('Pedro','111111112','High','Chestnut Hill','Laboratory','Transportation','Done',prisma,'','','','','','','car','parking','','','','','','','');
    await insertServiceRequest('Mathew','111111113','Low','Chestnut Hill','Radiology','Language','Done',prisma,'Spanish','French','','','','','','','','','','','','','');
    await insertServiceRequest('Alex','111111111','Medium','Faulkner Hospital','Laboratory','Security','Working',prisma,'','','','','','Assault','','','','','','','','','');
    await insertServiceRequest('Andrea','111111115','Low','Patriot Place','Laboratory','Language','Done',prisma,'Spanish','French','','','','','','','','','','','','','');
}
